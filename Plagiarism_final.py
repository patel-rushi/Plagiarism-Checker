...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.e1=QLineEdit(MainWindow)
        #e1.setValidator(QIntValidator())
        #e1.setMaxLength(4)
        self.e1.move(610,82)
        self.e1.setFixedHeight(20)
        self.e1.setFixedWidth(150)
...
"color: rgb(255, 255, 255);")
        ...
        #==============Warning label================
        # self.lbl_noname = QtWidgets.QLabel(MainWindow)
        # self.lbl_noname.setGeometry(QtCore.QRect(0, 0,610,82))
        # self.lbl_noname.setObjectName("lbl_noname")
...
#======================Set label names=====================================================
    def retranslateUi(self, MainWindow):
        ...
        #self.lbl_noname.setText(_translate("MainWindow", "pp"))
...
#===================================Plagiarism Checking Process=========================================
    ...
    def save(self):
        print("save called")
        save_filename=self.e1.text()
        if(save_filename!=""):
            pdfReportGen.setData(save_filename, glb_plagiarism_result)
